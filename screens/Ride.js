      ...
      .then(doc => {
        ...
        if (bike.is_bike_available) {
          ...
          //Add a alert box to display "You have rented the bike for next 1 hour. Enjoy your ride!!"
            alert("You have rented the bike for the next 1 hour. Enjoy your ride!!");
...
//Add the code to make TextInput editable for accepting userID
        onChangeText={text => this.setState({ userId: text })} // Add this line to make the TextInput editable for accepting userID
              placeholder={"User Id"}
